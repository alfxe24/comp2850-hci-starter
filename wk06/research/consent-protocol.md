...
**Date**: [2025-11-20]
**Researcher**: [Alfie Whitham | bwqk3256]

---

## Purpose

Short Peer Interviews to understand peoples experiences with task managing software, and what accessibility needs they may require from said software.

## What You'll Do

I'll ask 3-5 questions about task management experiences, taking brief notes. **No recordings** unless you explicitly agree.
...
- **Where**: Private GitHub repository (not shared publicly)
- **Access**: Me, teaching staff (if requested for marking)
- **Duration**: Kept for duration of examination year, anonymised for portfolio
